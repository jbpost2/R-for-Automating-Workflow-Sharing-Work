...
> - Go back to template, change output type and knit.  Add [some HTML options](https://bookdown.org/yihui/rmarkdown/html-document.html) (careful to drop down lines and use spacing as done in documentation).
...
- Go through [this document (we'll come help!) to set things up  
