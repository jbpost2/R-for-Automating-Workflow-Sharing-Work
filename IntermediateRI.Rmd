...
- Place the [TextActivityPlainText.Rmd]("files/TextActivityPlainText.Rmd") file in the project folder  
...
[NHL Example html]("files/GetData.html"), [NHL Example Rmd]("files/GetData.Rmd")
